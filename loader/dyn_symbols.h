...
DYN_SYMBOL_DATA_DEFAULT(_ZdaPv)
DYN_SYMBOL_DATA_DEFAULT(_ZdlPv)
DYN_SYMBOL_DATA_DEFAULT(_Znaj)
DYN_SYMBOL_DATA_DEFAULT(_Znwj)
...
DYN_SYMBOL(glBindTexture, glBindTexture_hook)
...
DYN_SYMBOL(glDrawArrays, glDrawArrays_hook)
...
DYN_SYMBOL(glViewport, glViewport_hook)
