...
// fixme ndk stuff
DYN_SYMBOL(_ZNKSt6__ndk120__vector_base_commonILb1EE20__throw_length_errorEv, ret0)
DYN_SYMBOL(_ZNSt6__ndk112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6resizeEjc, ret0)
DYN_SYMBOL(_ZNSt6__ndk112__next_primeEj, ret0)
DYN_SYMBOL(_ZNSt6__ndk119__shared_weak_count14__release_weakEv, ret0)
...
DYN_SYMBOL(_ZNSt6__ndk16chrono12steady_clock3nowEv, ret0)
...
DYN_SYMBOL_DEFAULT(eglDestroySurface)
...
DYN_SYMBOL(glGetShaderiv, glGetShaderiv_hook)
DYN_SYMBOL(glGetUniformLocation, glGetUniformLocation_hook)
DYN_SYMBOL_DEFAULT(glLinkProgram)
DYN_SYMBOL(glShaderSource, glShaderSource_hook)
DYN_SYMBOL(glTexImage2D, glTexImage2D_hook)
...
DYN_SYMBOL_DEFAULT(sincos)
DYN_SYMBOL_DEFAULT(sincosf)
